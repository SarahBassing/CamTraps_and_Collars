 ...
 #'    coord_sf(xlim = c(490000.0, 780000.0), ylim = c(102000.0, 250000.0))
  ...
  #### 6. Plotting betas estimated from different use:avail ratios  ####
  ...
  #'  Read in RSFs based on different use:available ratios & extract coefficients
  #'  Summer Wolf RSFs
  ...
  rm(wolf_rsf_1000avail)
  # load("./Outputs/RSF_output/Subsampled_Available_Pts/wolf_rsf_2Kavail_2022-05-07.RData")
  # wolf_2Kavail_coef <- rsf_out(wolf_rsf_2Kavail, spp = "Wolf", navail = "1:2000 ratio")
  # wolf_2Kavail_coef <- do.call(rbind.data.frame, wolf_2Kavail_coef)
  # save(wolf_2Kavail_coef, file = "./Outputs/RSF_output/Subsampled_Available_Pts/wolf_rsf_2Kavail_coeffs.RData")
  # rm(wolf_rsf_2Kavail)
  ...
  rm(wtd_rsf_200avail)
  load("./Outputs/RSF_output/Subsampled_Available_Pts/wtd_rsf_1000avail_2022-04-30.RData")
  ...
  rm(wtd_rsf_1000avail)
  # load("./Outputs/RSF_output/Subsampled_Available_Pts/wtd_rsf_2Kavail_2022-05-07.RData")
  # wtd_2Kavail_coef <- rsf_out(wtd_rsf_2Kavail, spp = "White-tailed Deer", navail = "1:2000 ratio")
  # wtd_2Kavail_coef <- do.call(rbind.data.frame, wtd_2Kavail_coef)
  # save(wtd_2Kavail_coef, file = "./Outputs/RSF_output/Subsampled_Available_Pts/wtd_rsf_2Kavail_coeffs.RData")
  # rm(wtd_rsf_2Kavail)
